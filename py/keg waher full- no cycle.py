...
def get_current_settings():
    ...
    return {
        'FirstAirPurgeRecure': row[1],
        'FirstAirPurgeTon': row[2],
        'FirstAirPurgeToff': row[3]
    }
...
def update_variable():
    ...
    try:
        ...
        if 'index0' in request.form and request.form['index0']:
            new_value = float(request.form['index0'])
            with lock:
        ...
        if 'index1' in request.form and request.form['index1']:
            new_value = float(request.form['index1'])
            with lock:
        ...
        if 'index2' in request.form and request.form['index2']:
            new_value = float(request.form['index2'])
            with lock:
